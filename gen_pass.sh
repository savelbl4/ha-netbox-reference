...
VRRP_PASS=$(escape_slashes "$(generate_password 8)")
PG_SUPER_PASS=$(escape_slashes "$(generate_password 16)")
REPL_PASS=$(escape_slashes "$(generate_password 15)")
REDIS_PASS=$(escape_slashes "$(generate_password 12)")
PGB_ADMIN_PASS=$(escape_slashes "$(generate_password 10)")
PGB_STATS_PASS=$(escape_slashes "$(generate_password 13)")
NETBOX_PEPPERS=$(openssl rand -hex 32)
NETBOX_SECRET=$(escape_slashes "$(generate_password 50)")
